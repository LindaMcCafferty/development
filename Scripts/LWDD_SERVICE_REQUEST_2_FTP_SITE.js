...
try {
	var getResult = aa.cap.getByAppType("ServiceRequest", null, null, null);
	if (getResult.getSuccess()) 
	  ...
	  aa.util.deleteFile(theDirectoryName + "/ACCELA_SERVICE_REQUESTS.CSV");
          fileObj = aa.util.writeToFile(message, theDirectoryName + "/ACCELA_SERVICE_REQUESTS.CSV");

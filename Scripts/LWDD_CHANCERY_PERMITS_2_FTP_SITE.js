...
try {
	var getResult = aa.cap.getByAppType("ChanceryReview", null, null, null);
	if (getResult.getSuccess()) 
	  ...
	  aa.util.deleteFile(theDirectoryName + "/ACCELA_CHANCERY.CSV");	
          fileObj = aa.util.writeToFile(message,  theDirectoryName + "/ACCELA_CHANCERY.CSV");

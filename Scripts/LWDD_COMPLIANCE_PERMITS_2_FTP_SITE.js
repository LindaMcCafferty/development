...
try {
	var getResult = aa.cap.getByAppType("Compliance", null, null, null);
	if (getResult.getSuccess()) 
	   {
		...
		var message = "Failed!  error " + getResult.getErrorMessage();
          ...
          aa.util.deleteFile(theDirectoryName + "/ACCELA_COMPLIANCE.CSV");
          fileObj = aa.util.writeToFile(message, theDirectoryName + "/ACCELA_COMPLIANCE.CSV");

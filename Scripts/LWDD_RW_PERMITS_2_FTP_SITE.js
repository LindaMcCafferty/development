...
try {
	...
	if (getResult.getSuccess()) 
	{
		...
		var message = "\"" + "RECORDID" + "\"" + " ," + "\"" + "ACCELAID" + "\"" +  " ," + "\"" + "DOCCOUNT" + "\"" + '\n';
	...
	var message = "Failed!  error " + getResult.getErrorMessage();
         ...
         aa.util.deleteFile(theDirectoryName + "/ACCELA_RW_PERMITS.CSV");

	fileObj = aa.util.writeToFile(message, theDirectoryName + "/ACCELA_RW_PERMITS.CSV");

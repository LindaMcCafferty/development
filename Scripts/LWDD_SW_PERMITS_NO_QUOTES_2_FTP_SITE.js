...
try {
	...
	aa.util.deleteFile(theDirectoryName + "/ACCELA_SW_PERMITS_NO_QUOTES.CSV");
	fileObj = aa.util.writeToFile(message, theDirectoryName + "/ACCELA_SW_PERMITS_NO_QUOTES.CSV");

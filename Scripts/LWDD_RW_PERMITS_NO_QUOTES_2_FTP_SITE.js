...
try {
	...
	aa.util.deleteFile(theDirectoryName + "/ACCELA_RW_PERMITS_NO_QUOTES.CSV");
	fileObj = aa.util.writeToFile(message, theDirectoryName + "/ACCELA_RW_PERMITS_NO_QUOTES.CSV");
